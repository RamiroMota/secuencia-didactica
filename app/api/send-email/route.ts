...
export async function POST(request: NextRequest) {
  try {
    ...
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        user: process.env.EMAIL_USER || "ramiro.mota.tb@gmail.com",
        pass: process.env.EMAIL_PASS || "tzvm okcr annz ajbv",
      },
    })
    ...
    const mailOptions = {
      from: process.env.EMAIL_USER || "ramiro.mota.tb@gmail.com",
      to: destinationEmail,
